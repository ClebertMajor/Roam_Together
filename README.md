...
-Explore (‘explore.html’): navigate through profiles of all different users on the website. View location and a preview of information about the user. Search for certain destinations or filter them out based on personal preferences. Use the drop down button in the corner to navigate through the pages. 
- Profile (`profile.html`): view and edit your profile
- About (`about.html`): learn more about Roam_Together and its purpose.
For explore page: 
# Explore Page
	This is a responsive, front-end application featuring a dynamic “Explore page”. The design ensures optimal display across all devices. It includes real-time search, category filtering using data attributes, and a menu button. 
